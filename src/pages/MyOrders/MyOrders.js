...
const MyOrders = () => {
    ...
    const handleDeleteOrder = id => {
        ...
        if (proceed) {
            const url = `https://dry-spire-17726.herokuapp.com/orders/${id}`;
            fetch(url, {
                method: 'DELETE',
            })
                .then(res => res.json())
    ...
    return (
        <div>
            ...
            <div className="container">
                ...
                <div className="row my-3 bg-dark text-light py-2">
                ...
                {/* display orders */}
                {
                    orders.map(order => <div key={order._id} className="row bg-primary py-2 mb-3">
                        ...
                        <div className="col-md-2">
                            <p className="text-center text-primary fs-4">{order.orderStatus}</p>
                        </div>
                        <div className="col-md-3 text-center">
